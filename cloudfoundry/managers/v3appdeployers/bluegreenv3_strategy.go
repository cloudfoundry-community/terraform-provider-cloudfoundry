...
// type metadataV3Request struct {
// 	Metadata metadata `json:"metadata"`
// }

// type metadataV3Type string
...
// const (
// 	appV3Metadata          metadataV3Type  = "apps"
// 	stopAppV3Timeout       time.Duration = 15 // CF SHOULD send a SIGKILL if an app is not stopped after 10 seconds
// 	delayBetweenV3Requests time.Duration = 1
// )

// NewBlueGreenV3 initializes a new b-g strategy
func NewBlueGreenV3(bitsManager *bits.BitsManager, client *ccv3.Client, rawClient *raw.RawClient, runBinder *RunBinder, standard *Standard) *BlueGreenV3 {
	return &BlueGreenV3{
...
// func (s BlueGreenV3) Deploy(appDeploy AppDeploy) (AppDeployResponse, error) {
...
// func (s BlueGreenV3) Restage(appDeploy AppDeploy) (AppDeployResponse, error) {
...
// func (BlueGreenV3) IsCreateNewApp() bool {
// 	return true
// }

func (BlueGreenV3) Names() []string {
	return []string{"blue-green", "blue-green-v3"}
}

// // These methods should be integrated in the CCV clients at some point
// func metadataV3Update(appGuid string, t metadataType, client *raw.RawClient, metadata metadata) error {
...
// func metadataV3Retrieve(appGuid string, t metadataType, client *raw.RawClient) (metadata, error) {
...
// func pathV3Metadata(t metadataType, appGuid string) string {
...
// func isAppV3Stopped(clientV3 *ccv3.Client, appGUID string) (bool, error) {
// 	isStopped := false
