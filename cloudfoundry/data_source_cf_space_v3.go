...
func dataSourceSpaceV3() *schema.Resource {
...
func dataSourceSpaceV3Read(ctx context.Context, d *schema.ResourceData, meta interface{}) diag.Diagnostics {
	...
	d.Set("org", orgId)
	d.Set("quota", space.Relationships["Quota"].GUID) // to be validated
