...
replace code.cloudfoundry.org/cli => github.com/cloudfoundry-community/cloudfoundry-cli v6.44.1-0.20221116160217-adea22bf4b55+incompatible
...
require github.com/hashicorp/terraform-plugin-log v0.7.0
